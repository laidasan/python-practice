...
# stock_2330 = stock_2330.fetch(2019,5)
# stock_2330_pd = pd.DataFrame(stock_2330)
# print(stock_2330_pd)
...
# stock_2353 = twstock.Stock('2353')
# stock_2357 = twstock.Stock('2357')
# stock_2376 = twstock.Stock('2376')
# stock_2377_2019_3 = stock_2377.fetch_from(2019,5)
# stock_2353_2019_3 = stock_2353.fetch_from(2019,5)
# stock_2357_2019_3 = stock_2357.fetch_from(2019,5)
# stock_2376_2019_3 = stock_2376.fetch_from(2019,5)
# stock_2377_2019_3_pd = pd.DataFrame(stock_2377_2019_3)
# stock_2353_2019_3_pd = pd.DataFrame(stock_2353_2019_3)
# stock_2357_2019_3_pd = pd.DataFrame(stock_2357_2019_3)
# stock_2376_2019_3_pd = pd.DataFrame(stock_2376_2019_3)
# stock_2377_2019_3_pd = stock_2377_2019_3_pd.set_index('date')
# stock_2353_2019_3_pd = stock_2353_2019_3_pd.set_index('date')
# stock_2357_2019_3_pd = stock_2357_2019_3_pd.set_index('date')
# stock_2376_2019_3_pd = stock_2376_2019_3_pd.set_index('date')
# fig = plt.figure(figsize=(10,6))
# plt.plot(stock_2377_2019_3_pd.close,ls='solid',color='#00aaff',label='2377')
# plt.plot(stock_2353_2019_3_pd.close,ls='solid',color='#000000',label='2353')
# plt.plot(stock_2357_2019_3_pd.close,ls='solid',color='#66FFFF',label='2357')
# plt.plot(stock_2376_2019_3_pd.close,ls='solid',color='#FF0000',label='2376')
...
# plt.plot(df_2376['Close'],ls='solid',color='#ffaa00',label='2376')
# plt.plot(df_2377['Close'],ls='solid',color='#ff0000',label='2377')
# plt.plot(df_2353['Close'],ls='solid',color='#00eeaa',label='2353')
# plt.plot(df_2357['Close'],ls='solid',color='#0066aa',label='2357')
# plt.title('2376',loc='right')
# plt.yticks(np.arange(10,300,30))
# plt.xlabel('Date')
# plt.ylabel('Price')
# plt.grid(True,axis='y')
